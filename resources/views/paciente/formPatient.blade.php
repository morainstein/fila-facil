...
<section class="formPatient">

    {{-- <x-registerPatient :$clinicaId> </x-registerPatient> --}}
    @php $clinicaId = isset($clinicaId) ? $clinicaId : null ; @endphp
    
    <form class="dashboard-sections caixa register-patient" 
    action="{{ route('paciente.store',['clinicaId'=>$clinicaId])}}" 
    method="post">
      @csrf
      <div>
